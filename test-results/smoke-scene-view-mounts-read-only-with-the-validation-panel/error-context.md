...
- Name: smoke.spec.ts >> scene view mounts read-only with the validation panel
- Location: e2e/smoke.spec.ts:29:1
...
Locator: getByTestId('scene-editor')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('scene-editor')
