...
- Name: real/search.spec.ts >> real project search >> typed scene text is found by the project search
- Location: e2e/real/search.spec.ts:5:3
...
- main:
  ...
  - text: Email
  - textbox "Email": e2e-1788102202749-519941@example.com
  - text: Password
