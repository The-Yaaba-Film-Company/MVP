...
- Name: real/project-flow.spec.ts >> real writer flow >> reloading the projects page keeps the logged-in session
- Location: e2e/real/project-flow.spec.ts:58:3
...
- main:
  ...
  - text: Email
  - textbox "Email": e2e-1788102216116-678317@example.com
  - text: Password
