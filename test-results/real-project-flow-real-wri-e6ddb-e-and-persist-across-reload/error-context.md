...
- Name: real/project-flow.spec.ts >> real writer flow >> create a scene, edit it, autosave, and persist across reload
- Location: e2e/real/project-flow.spec.ts:5:3
...
- main:
  ...
  - text: Email
  - textbox "Email": e2e-1788102189576-815794@example.com
  - text: Password
