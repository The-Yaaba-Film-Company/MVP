...
- Name: real/project-flow.spec.ts >> real writer flow >> scene navigator lists the created scene with a derived heading
- Location: e2e/real/project-flow.spec.ts:40:3
...
- main:
  ...
  - text: Email
  - textbox "Email": e2e-1788102202190-292810@example.com
  - text: Password
