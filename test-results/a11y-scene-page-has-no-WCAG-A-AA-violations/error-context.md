...
- Name: a11y.spec.ts >> scene page has no WCAG A/AA violations
- Location: e2e/a11y.spec.ts:47:1
...
Locator: getByTestId('validation-panel')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('validation-panel')
